...
export default function ComplaintForm() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "pending": return "bg-amber-300 text-gray-900";
      case "Inprogress": return "bg-teal-300 text-gray-900";
      case "Resolved": return "bg-green-300 text-gray-900";
      case "Rejected": return "bg-red-300 text-gray-900";
